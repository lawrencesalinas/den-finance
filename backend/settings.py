...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOST', 'http://127.0.0.1:8000').split(" ")
print(os.environ.get('ALLOWED_HOST', 'http://127.0.0.1:8000').split(" "),'test')
...
# MEDIA_ROOT = user uploaded content
